...
<body background="banner.jpg">
    <div class="content">
        <div class="hasiera">
            <table>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><p style="background-color: lightblue"> Hemen datuak aldatu dezakezu. Nahi dituzun izena eta emaila aldatzeko sartu ezazu berria. </p></td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        </div>
    ...
    <div class="content">
        <div class="inputak">
            ...
            <tr>
                <td>&nbsp;</td>
                <td><input id="izena" type="text" name="izena" placeholder="Izena berria sartu"  title="Zure izena sartu." required/></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td><input id="emaila" type="email" name="emaila" placeholder="Email berria sartu" title="Zure emaila idatzi." required/></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
