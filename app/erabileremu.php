...
<head>
    ...
    <link rel="stylesheet" href="styleerab.css?v=<?php $tiempo_UNIX=time(); echo date("d/m/Y", $tiempo_UNIX); ?>">
</head>
        ...
        <div class="botoiak">
            <form name = "saioitxi" class = "inputak" action = "erabileremu.php" method = "POST">
                <table>
                    <tr>
                        <td>&nbsp;</td>
                        <td><input id="bueltatuBot" type="submit" name="bueltatuBot" value="Saioa Itxi<?php session_destroy(); ?>"/></td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </form>
